"""
Django settings for sampletestapp0099_1 project.
...
ROOT_URLCONF = 'sampletestapp0099_1.urls'
...
WSGI_APPLICATION = 'sampletestapp0099_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sampletestapp0099_1 API",
    "DESCRIPTION": "API documentation for sampletestapp0099_1 App",
    "VERSION": "v1",
}
